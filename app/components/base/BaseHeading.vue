<script setup lang="ts">
  ...
  const style = computed(() => {
    return {
      'text-4xl lg:text-7xl': props.is === 'h1',
      'text-3xl lg:text-5xl': props.is === 'h2',
      'text-2xl lg:text-3xl': props.is === 'h3',
      'text-xl lg:text-2xl': props.is === 'h4',
      'text-lg lg:text-xl': props.is === 'h5',
      'text-base lg:text-lg': props.is === 'h6',
    };
  });
</script>
